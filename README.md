...
<!-- Tech Stack Icons from FontAwesome -->
<i class="fab fa-js-square" style="font-size: 120px; color: #f0db4f;"></i>
<i class="fab fa-python" style="font-size: 120px; color: #306998;"></i>
<i class="fab fa-react" style="font-size: 120px; color: #61dafb;"></i>
<i class="fab fa-node-js" style="font-size: 120px; color: #8cc84b;"></i>
<i class="fab fa-docker" style="font-size: 120px; color: #2496ed;"></i>
<i class="fab fa-git" style="font-size: 120px; color: #f34f29;"></i>
<i class="fab fa-github" style="font-size: 120px; color: #333;"></i>
<i class="fab fa-visualstudio" style="font-size: 120px; color: #0061f2;"></i>
